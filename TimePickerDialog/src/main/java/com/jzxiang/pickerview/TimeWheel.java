...
public class TimeWheel {
    ...
    OnWheelChangedListener yearListener = (wheel, oldValue, newValue) -> updateMonths();
    OnWheelChangedListener monthListener = (wheel, oldValue, newValue) -> updateDays();
    OnWheelChangedListener dayListener = (wheel, oldValue, newValue) -> updateHours();
    OnWheelChangedListener minuteListener = (wheel, oldValue, newValue) -> updateMinutes();
